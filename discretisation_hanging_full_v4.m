...
%Provides discretised variables and their jacobians at relevant points on the grid. Accounts for
%variable cell edge and network edge lengths in both horizontal and
%vertical directions; implements centered scheme for both vorticity and stream
